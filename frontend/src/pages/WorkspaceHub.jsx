...
export default function WorkspaceHub({ administration = false }) {
  const { t } = useLanguage();
  const links = administration ? [["Users & Roles", "/users"], ["Cost Centers", "/cost-centers"], ["Approval Rules", "/configuration/approval-rules"], ["BBVA Configuration", "/configuration/bank-formats"], ["Exchange Rates", "/exchange-rates"]] : [["A2 Batch Invoices", "/batch-invoices"], ["Invoice Observations", "/accounting/invoice-observations"], ["Accounts Payable", "/accounting/payables"]];
  const additional = [["Requests", "/requests"], ["Approvals", "/approvals"], ["Budget Control", "/budget"], ["Accounting", "/accounting"], ["Payments", "/treasury"], ["Payment History", "/treasury/history"], ["Management Reports", "/reports"], ["Suppliers", "/suppliers"], ["Reimbursement Banking", "/reimbursement-bank"], ["Accounting Periods", "/accounting/periods"], ["SIRE", "/accounting/sire"], ["Expense Types", "/expense-types"], ["Budget Rules", "/configuration/budget-rules"], ["Budget Allocations", "/configuration/budget-allocations"], ["A2 Batch Invoices", "/batch-invoices"]];
